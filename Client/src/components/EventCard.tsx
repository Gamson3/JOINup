    ...
    <div className={baseClasses}>
      ...
      <div className={`relative ${getImageHeight()} bg-gradient-to-r from-gray-100 to-gray-200`}>
        {event.images.thumbnail ? (
          ...
          <div className="w-full h-full bg-gradient-to-br from-[#6A011D]/10 to-[#6A011D]/30 flex items-center justify-center">
            <span className="text-[#6A011D] font-semibold text-lg">
        ...
        <div className="absolute top-2 right-2 w-10 h-10 bg-white rounded-lg shadow-sm flex items-center justify-center">
          {event.organizer.logo ? (
            ...
            <div className="w-6 h-6 bg-[#6A011D] rounded text-white text-xs flex items-center justify-center font-semibold">
      ...
      <div className="p-3">
        ...
        {/* Title */}
        <h3 className={`font-semibold text-gray-900 mb-2 line-clamp-2 group-hover:text-[#6A011D] transition-colors ${
        ...
        <div className="flex flex-wrap gap-1 mb-3">
          {event.categories.slice(0, variant === 'compact' ? 1 : 2).map((category) => (
            <span
              key={category.id}
              className="px-2 py-1 bg-gray-100 text-gray-600 text-xs rounded-full hover:bg-[#6A011D]/10 hover:text-[#6A011D] transition-colors cursor-pointer"
            >
              {category.name}
            </span>
          ))}
        ...
        <div className="pt-3 border-t border-gray-100">
          <a
            ...
            className="inline-flex items-center text-sm text-[#6A011D] hover:text-[#550117] transition-colors font-medium"
          >

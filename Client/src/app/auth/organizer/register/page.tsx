...
//       await register(formData.email.trim(), formData.password, fullName, 'ORGANIZER');
//     } catch (err: any) {
...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-[#6A011D] to-[#8B0000] flex items-center justify-center py-6 px-4 sm:px-6 lg:px-8">
...
//               <Link 
//                 href="/auth/login" 
//                 className="inline-flex items-center px-3 py-1.5 text-sm font-medium text-blue-600 bg-blue-100 hover:bg-blue-200 rounded transition-colors"
//               >
